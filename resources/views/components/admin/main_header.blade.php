...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form role="form" id="searchForm" method="get" action="#" class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" type="search" id="keyWord" name="key_word" placeholder="Search" aria-label="Search" style="width: 400px;">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <!-- <a href="{{ url('admin/media') }}" class="dropdown-item">
            <div class="media">
              <div class="media-body">
                <h3 class="dropdown-item-title">My Channel</h3>
              </div>
            </div>
          </a> -->
