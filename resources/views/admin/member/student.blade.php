              ...
              <div class="row">
                <div class="col-sm-12">
                  <table id="classListTable" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                    <thead>
                      <tr role="row">
                      <th class="sorting" tabindex="0" aria-controls="classListTable" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">admition_number</th>
                    ...
                    <tfoot>
                      <tr>
                      <th rowspan="1" colspan="1">admition_number</th>
  ...
  $(function () {
    ...
    $('#classListTable').DataTable({
      ...
      ajax: {
        ...
        //"type": "POST",
        url: "{{ url('admin/member/student/list') }}",
      },
      columns: [
          {data: 'admition_number', name: 'admition_number'},
