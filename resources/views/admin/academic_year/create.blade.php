            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card card-primary">
                        ...
                        <form role="form" id="academicYearCreate" method="post" action="{{ route('academic-year-store') }}">
                            {!! csrf_field() !!}
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="inputName">Academic Year</label>
                                    <input type="text" id="academicYear" name="academic_year" class="form-control" value="">
                                </div>
                                <div class="form-group">
